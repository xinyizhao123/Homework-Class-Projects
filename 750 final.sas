...
covtest 'H0: No random efects' zerog;
covtest 'H0: Complete independence' INDEP;
covtest/wald;
...
estimate "collab II interaction" collabi 1 collabi*admprevcocdi 0.1/ exp cl;
run;
